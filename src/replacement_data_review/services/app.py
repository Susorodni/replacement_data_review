...
from replacement_data_review.config import SUPPORTED_FILE_EXTENSIONS
from replacement_data_review.util import address_sort_key
from replacement_data_review.services.asset_manager import build_assets
...
class App:
    def __init__(self, root: Tk) -> None:
        ...
        self.root = root
        self.root.title("Replacement Data Review Tool")
